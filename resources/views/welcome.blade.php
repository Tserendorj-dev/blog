                        ...
                        <div class="col-12 col-lg-7">
                            <div class="single-blog-post featured-post">
                                ...
                                <div class="post-data">
                                    ...
                                    <a href="#" class="post-title"><h6>{{ $lastPosts[0]->title }}</h6></a>
                                    <div class="post-meta">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="#" class="post-comment"><img src="img/core-img/chat.png" alt=""> <span>{{ $lastPosts[0]->comments->count() }}</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-lg-5">
                            ...
                            <div class="single-blog-post featured-post-2">
                                ...
                                <div class="post-data">
                                    ...
                                    <div class="post-meta">
                                        <a href="#" class="post-title"><h6>{{ $last->title }}</h6></a>
                                        <!-- Post Like & Post Comment -->
                                        <div class="d-flex align-items-center">
                                            <a href="#" class="post-like"><img src="img/core-img/like.png" alt=""> <span>{{ $last->views }}</span></a>
                                            <a href="#" class="post-comment"><img src="img/core-img/chat.png" alt=""> <span>{{ $last->comments->count() }}</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
